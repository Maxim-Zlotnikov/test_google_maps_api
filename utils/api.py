...
class GoogleMapsApi:
    ...
    def create_new_place():
        ...
        post_url = base_url + post_resourse + key  # URL метода Post
        print(post_url)
    ...
    def get_new_place(place_id):
        ...
        get_url = base_url + get_resource + key + "&place_id=" + place_id  # URL метода Get
        print(get_url)
    ...
    def put_new_place(place_id):
        ...
        put_url = base_url + put_resource + key  # URL метода Put
        print(put_url)
    ...
    def delete_new_place(place_id):
        ...
        delete_url = base_url + delete_resource + key  # URL метода Delete
        print(delete_url)
